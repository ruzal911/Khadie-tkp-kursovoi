...
if(isset($_POST['submit'])){
   ...
   if($select->rowCount() > 0){
      ...
      if($pass != $cpass){
         $message[] = 'введеный пароль не соответствует прошлому!';
      }else{
         ...
         if($insert){
            if($image_size > 2000000){
               $message[] = 'размер картинки слишком большой!';
            }else{
...
<section class="form-container">
   ...
   <form action="" enctype="multipart/form-data" method="POST">
      ...
      <input type="password" name="cpass" class="box" placeholder="Повторите пароль" required>
      <input type="file" name="image" class="box" required accept="image/jpg, image/jpeg, image/png">
      <input type="submit" value="зарегистрироваться" class="btn" name="submit">
      <p>Уже есть аккаунт? <a href="login.php"></a>войдите</p>
   </form>
