...
<section class="user-accounts">
   ...
   <h1 class="title">Пользовательский аккаунт</h1>
   ...
   <div class="box-container">
      ...
      <div class="box" style="<?php if($fetch_users['id'] == $admin_id){ echo 'display:none'; }; ?>">
         ...
         <p> id пользователя : <span><?= $fetch_users['id']; ?></span></p>
         <p> имя : <span><?= $fetch_users['name']; ?></span></p>
         <p> email : <span><?= $fetch_users['email']; ?></span></p>
         <p> тип пользователя : <span style=" color:<?php if($fetch_users['user_type'] == 'admin'){ echo 'orange'; }; ?>"><?= $fetch_users['user_type']; ?></span></p>
