...
<section class="p-category">
   ...
   <a href="category.php?category=fruits">Фрукты</a>
   <a href="category.php?category=vegitables">Овощи</a>
   <a href="category.php?category=fish">Рыба</a>
   <a href="category.php?category=meat">Мясо</a>
...
<section class="products">
   ...
   <?php
      ...
      echo '<p class="empty">Нет добавленных продуктов!</p>';
   }
   ?>
