...
<section class="wishlist">
   ...
   <form action="" method="POST" class="box">
      <a href="wishlist.php?delete=<?= $fetch_wishlist['id']; ?>" class="fas fa-times" onclick="return confirm('удалить из избранного?');"></a>
   ...
   <?php
      ...
      echo '<p class="empty">ваш список желаний пуст</p>';
   }
   ?>
   </div>
   ...
   <div class="wishlist-total">
      ...
      <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>">удалить все</a>
   </div>
