...
<section class="placed-orders">
   ...
   ?>
   <div class="box">
      <p> доделать order.php : <span><?= $fetch_orders['placed_on']; ?></span> </p>
      ...
      <p> ваш заказ : <span><?= $fetch_orders['total_products']; ?></span> </p>
      <p> сумма : <span>$<?= $fetch_orders['total_price']; ?>/-</span> </p>
   ...
   <?php
      ...
      echo '<p class="empty">Нет ни одного заказа!</p>';
   }
   ?>
